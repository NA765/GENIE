...
def main():
    ...
    parser.add_argument("--output_folder", default="annotation_real_high_level", help="Path to the folder where output text files will be saved.")
